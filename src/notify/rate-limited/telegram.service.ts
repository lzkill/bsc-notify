...
export class TelegramService {
  ...
  async init() {
    ...
    if (this.config.telegram.token) {
      ...
      this.bot.command('bns_enable', async (ctx) => {
        try {
      ...
      this.bot.command('bns_disable', async (ctx) => {
        try {
      ...
      this.bot.command('bns_config', async (ctx) => {
        try {
      ...
      this.bot.command('bns_ping', async (ctx) => {
        try {
      ...
      this.bot.command('bns_help', async (ctx) => {
        try {
